...
export type IActor = {
    ...
    readonly onMouseClick$: ISubscriber<boolean>;
    readonly onMouseLeftDrop$: ISubscriber<any>;
    readonly onMouseLeftDrag$: ISubscriber<any>;
    readonly onMouseRightClick$: ISubscriber<boolean>;
    readonly onMouseLeftClick$: ISubscriber<boolean>;
    readonly onMouseOver$: ISubscriber<boolean>;
    readonly onDestroyed$: ISubscriber<boolean>;
